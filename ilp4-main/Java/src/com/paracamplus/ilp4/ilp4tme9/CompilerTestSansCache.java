...
public class CompilerTestSansCache extends com.paracamplus.ilp3.compiler.test.CompilerTest {
    
    protected static String[] samplesDirName = { "SamplesTME9"};
    protected static String pattern = ".*\\.ilpml";
    protected static String scriptCommand = "Java/src/com/paracamplus/ilp4/ilp4tme9/compileThenRun.sh +gc";
    protected static String XMLgrammarFile = "XMLGrammars/grammar4.rng";
    
    public CompilerTestSansCache(final File file) {
    	super(file);
    }    
