package com.paracamplus.ilp2.ilp2tme4.parser.ilpml.methode1;
...
protected IASTfactory factory;
	...
	public void exitUnless(UnlessContext ctx) {
		IASTexpression[] vide = {};
		IASTexpression non = factory.newSequence(vide);
		ctx.node = factory.newAlternative(ctx.condition.node, non, ctx.body.node);
	}		
}
